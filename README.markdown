http://kinomir-anahoret.herokuapp.com/
	...
	В нем используется:
		...
		- Автор ( если это user - то будет отображен ссылкой на свой профиль, в профиле будут все статьи опубликованные юзером 
		{ если текущий юзер смотрит на свой профиль - то у негобудет отображаться кнопочка Edit, где он может отредактировать свой 
		профиль - Пароль, имя, страну, город, аватар... доступ к этой странице есть только у текушего
		 }, если автор удалён - будет написано Delete и перечеркнуто) - на админа нет ссылки
